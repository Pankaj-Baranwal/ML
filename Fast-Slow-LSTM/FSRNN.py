...
class FSRNNCell(tf.contrib.rnn.RNNCell):
    ...
    def __call__(self, inputs, state, scope='FS-RNN'):
        ...
        # Defines a simple namespace to avoid name clashes
        with tf.variable_scope(scope):
            ...
            with tf.variable_scope('Fast_0'):
                ...
                # Args: input = [batch_size x input_size], 
    ...
    # Initialize the zero state of an LSTM unit.
    def zero_state(self, batch_size, dtype):
        # Returns a zero filled state tensor
